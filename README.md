...
- **Classes & objects** — a class as a blueprint, an object as an instance
- **Attributes & methods** — what an object knows and what it can do
- **`__init__` and `self`** — the constructor and the "my" pronoun
- **`__str__`** — controlling how an object is printed
- **Inheritance** — shared logic in a parent, unique logic in children
...
| Language | File |
| --- | --- |
| Russian  | [`index.html`](index.html) |
| Uzbek    | [`index-uz.html`](index-uz.html) |
